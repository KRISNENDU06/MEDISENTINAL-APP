              ...
              >
                ...
                <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3">
                  ...
                  <div className="flex flex-wrap items-center gap-2 shrink-0 pt-1 sm:pt-0">
                    ...
                    {/* Verified Google Maps Landmark Place Link */}
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-1 px-2.5 py-2 bg-slate-800 hover:bg-slate-700 text-slate-300 hover:text-white rounded-xl text-xs font-semibold border border-slate-700 transition-all shadow"
                      title="View verified landmark profile and reviews on Google Maps"
                    >
