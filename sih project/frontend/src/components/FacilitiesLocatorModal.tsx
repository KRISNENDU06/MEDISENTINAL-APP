...
export const FALLBACK_FACILITIES: Facility[] = [
  ...
  },
  {
    ...
    address: 'MCL Main Highway Road, Talcher, 759100',
    latitude: 20.9525,
    longitude: 85.2185,
  ...
  },
  {
    ...
    address: 'Kanika Chhak, Tulsipur, Cuttack, 753008',
    latitude: 20.4791,
    longitude: 85.8562,
  ...
  },
  {
    ...
    district: 'Cuttack',
    ward: 'Mangalabag & SCB Medical Zone',
    address: 'SCB Road, Mangalabag, Cuttack, 753007',
    latitude: 20.4620,
    longitude: 85.8820,
  ...
  {
    id: 'fac-pur-2',
    name: 'Sub-Divisional Hospital (SDH) Pipili',
    type: 'HOSPITAL',
    category: 'Govt Sub-Divisional Hospital',
    district: 'Puri',
    ward: 'Pipili Block Sub-Division',
    address: 'Main Road, Pipili, Puri, 752107',
    latitude: 20.1172,
    longitude: 85.8340,
  ...
  },
  {
    ...
    address: 'VIP Road, Police Line Square, Puri, 752002',
    latitude: 19.8125,
    longitude: 85.8275,
  ...
  },
  {
    ...
    address: 'Health Park, Panposh, Rourkela, 769004',
    latitude: 22.2455,
    longitude: 84.8105,
  ...
  },
  {
    ...
    address: 'Modipara Main Road, Sambalpur, 768001',
    latitude: 21.4715,
    longitude: 83.9725,
  ...
  },
  {
    ...
    address: 'Ainthapali Chowk, Sambalpur, 768004',
    latitude: 21.4905,
    longitude: 83.9905,
  ...
  },
  {
    ...
    address: 'OT Road, Balasore, 756001',
    latitude: 21.4925,
    longitude: 86.9285,
  ...
  },
  {
    ...
    address: 'Kuruda, Balasore, 756056',
    latitude: 21.4755,
    longitude: 86.9205,
  ...
  },
  {
    ...
    address: 'Old Town, Berhampur, 760001',
    latitude: 19.3085,
    longitude: 84.7855,
  ...
  },
  {
    ...
    address: 'Medical Bank Colony, Berhampur, 760004',
    latitude: 19.3185,
    longitude: 84.7985,
  ...
  {
    id: 'fac-may-2',
    name: 'Sub-Divisional Hospital (SDH) Rairangpur',
    type: 'HOSPITAL',
    category: 'Govt Sub-Divisional Hospital',
    district: 'Mayurbhanj',
    ward: 'Rairangpur Sub-Division',
    address: 'Main Road, Rairangpur, Mayurbhanj, 757043',
    latitude: 22.2725,
    longitude: 86.1725,
  ...
  },
  {
    ...
    address: 'Barbil Industrial Zone, Keonjhar, 758035',
    latitude: 22.1185,
    longitude: 85.3955,
  ...
  },
  {
    ...
    district: 'Keonjhar',
    ward: 'Keonjhar District Town',
    address: 'Mining Road, Keonjhar, 758001',
    latitude: 21.6275,
    longitude: 85.5805,
  ...
  },
  {
    ...
    address: 'Beheramal, Jharsuguda, 768203',
    latitude: 21.8625,
    longitude: 84.0155,
  ...
  },
  {
    ...
    district: 'Jharsuguda',
    ward: 'Jharsuguda Industrial Ward',
    address: 'Beheramal Square, Jharsuguda, 768203',
    latitude: 21.8585,
    longitude: 84.0105,
  ...
  {
    id: 'fac-kor-2',
    name: 'Sub-Divisional Hospital (SDH) Jeypore',
    type: 'HOSPITAL',
    category: 'Govt Sub-Divisional Hospital',
    district: 'Koraput',
    ward: 'Jeypore Commercial Town',
    address: 'Main Road, Jeypore, Koraput, 764001',
    latitude: 18.8525,
    longitude: 82.5725,
  ...
  },
  {
    ...
    address: 'Mill Street, Jeypore, Koraput, 764001',
    latitude: 18.8535,
    longitude: 82.5745,
  ...
  },
  {
    ...
    district: 'Rayagada',
    ward: 'Jaykaypur Zone',
    address: 'Jaykaypur, Rayagada, 765017',
    latitude: 19.2305,
    longitude: 83.4205,
  ...
  },
  {
    ...
    district: 'Rayagada',
    ward: 'Rayagada Town Ward',
    address: 'New Colony, Rayagada, 765001',
    latitude: 19.1695,
    longitude: 83.4175,
  ...
  },
  {
    ...
    district: 'Bolangir',
    ward: 'Rugudipada',
    address: 'Rugudipada, Bolangir, 767001',
    latitude: 20.7155,
    longitude: 83.4915,
  ...
  },
  {
    ...
    district: 'Bolangir',
    ward: 'Bolangir Town Ward',
    address: 'Daily Market, Bolangir, 767001',
    latitude: 20.7105,
    longitude: 83.4855,
  ...
  },
  {
    ...
    address: 'Canal Road, Bargarh, 768028',
    latitude: 21.3385,
    longitude: 83.6215,
  ...
  },
  {
    ...
    district: 'Dhenkanal',
    ward: 'College Road',
    address: 'College Road, Dhenkanal, 759001',
    latitude: 20.6625,
    longitude: 85.6015,
  ...
  },
  {
    ...
    district: 'Dhenkanal',
    ward: 'Dhenkanal Town Ward',
    address: 'College Chhak, Dhenkanal, 759001',
    latitude: 20.6595,
    longitude: 85.5985,
  ...
  },
  {
    ...
    address: 'Duburi, Kalinganagar, Jajpur, 755026',
    latitude: 20.9655,
    longitude: 86.0505,
  ...
  },
  {
    ...
    address: 'Station Road, Jajpur Road, 755019',
    latitude: 20.9515,
    longitude: 86.1325,
  ...
  },
  {
    ...
    district: 'Kendrapara',
    ward: 'Tinimuhani',
    address: 'Tinimuhani, Kendrapara, 754211',
    latitude: 20.5035,
    longitude: 86.4275,
  ...
  },
  {
    ...
    district: 'Jagatsinghpur',
    ward: 'Paradip Port & Refinery Ward',
    address: 'Port Gate Chhak, Paradip, 754142',
    latitude: 20.3185,
    longitude: 86.6185,
  ...
  },
  {
    ...
    district: 'Nayagarh',
    ward: 'College Road',
    address: 'College Road, Nayagarh, 752069',
    latitude: 20.1365,
    longitude: 85.1045,
  ...
  },
  {
    ...
    district: 'Nayagarh',
    ward: 'Nayagarh Town Ward',
    address: 'Main Road, Nayagarh, 752069',
    latitude: 20.1345,
    longitude: 85.1025,
  ...
  },
  {
    ...
    district: 'Kandhamal',
    ward: 'Phulbani District Town',
    address: 'Bus Stand, Phulbani, 762001',
    latitude: 20.1345,
    longitude: 84.1515,
  ...
  },
  {
    ...
    address: 'Bridge Road, Boudh, 762014',
    latitude: 20.8365,
    longitude: 84.3205,
  ...
  },
  {
    ...
    district: 'Baudh',
    ward: 'Boudh Town Ward',
    address: 'Bridge Chowk, Boudh, 762014',
    latitude: 20.8345,
    longitude: 84.3185,
  ...
  },
  {
    ...
    district: 'Subarnapur',
    ward: 'Palace Road',
    address: 'Palace Road, Sonepur, 767017',
    latitude: 20.8365,
    longitude: 83.9205,
  ...
  },
  {
    ...
    address: 'Khariar Mission Road, Nuapada, 766107',
    latitude: 20.2835,
    longitude: 82.7745,
  ...
  },
  {
    ...
    district: 'Nuapada',
    ward: 'Nuapada Town Ward',
    address: 'National Highway Chowk, Nuapada, 766105',
    latitude: 20.8345,
    longitude: 82.5345,
  ...
  },
  {
    ...
    district: 'Malkangiri',
    ward: 'Main Road',
    address: 'Main Road, Malkangiri, 764045',
    latitude: 18.3535,
    longitude: 81.9045,
  ...
  },
  {
    ...
    district: 'Gajapati',
    ward: 'Court Road',
    address: 'Court Road, Paralakhemundi, 761200',
    latitude: 18.8115,
    longitude: 84.1565,
  ...
  },
  {
    ...
    district: 'Deogarh',
    ward: 'Purunagarh',
    address: 'Purunagarh, Deogarh Town, 768108',
    latitude: 21.5365,
    longitude: 84.7375,
  ...
  },
  {
    ...
    district: 'Deogarh',
    ward: 'Deogarh Town Ward',
    address: 'National Highway, Deogarh Town, 768108',
    latitude: 21.5345,
    longitude: 84.7345,
            ...
            filtered.map((fac) => (
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3">
                  ...
                  {/* Actions: Direct Call, GPS Directions & Map Pin */}
                  <div className="flex flex-wrap items-center gap-2 shrink-0 pt-1 sm:pt-0">
                    ...
                    <a
                      ...
                      className="flex items-center gap-1.5 px-3 py-2 bg-blue-600/20 hover:bg-blue-600/30 text-blue-300 border border-blue-500/30 rounded-xl text-xs font-semibold transition-all active:scale-95"
                      title="Open Turn-by-Turn GPS Driving Directions to exact coordinates"
                    >
                      <Navigation className="w-3.5 h-3.5 text-blue-400" />
                      <span>GPS Navigate</span>
                    </a>

                    {/* Exact Pin Drop on Google Maps */}
                    <a
                      ...
                      title="View exact pinpoint marker on Google Maps"
                    >
                      <MapPin className="w-3.5 h-3.5 text-emerald-400" />
                      <span>Map Pin</span>
                    </a>

                    {/* Place Profile Search on Google Maps */}
                    <a
                      href={`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(`${fac.name}, ${fac.district}, Odisha`)}`}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-1.5 px-2.5 py-2 bg-slate-900 hover:bg-slate-800 text-slate-400 hover:text-slate-200 rounded-xl text-xs border border-slate-800 transition-all active:scale-95"
                      title="Search hospital photos, reviews, and entity details on Google Maps"
                    >
